...
export default function VirtualInterface({ y1, y2 }: VirtualInterfaceProps) {
    ...
    return (
        ...
        >
            {/* Main Container */}
            <div className="absolute inset-0 rounded-2xl overflow-hidden shadow-2xl border-4 border-slate-700">
                ...
                >
                    <div className="relative">
                        ...
                        />
                        {/* Name tag */}
                        <div className="absolute -top-7 left-1/2 -translate-x-1/2 bg-slate-900/90 px-2 py-0.5 rounded text-[10px] text-white whitespace-nowrap flex items-center gap-1 shadow-lg">
                ...
                <div className="absolute top-8 left-1/2 -translate-x-1/2 flex gap-2">
                    <motion.div
                        ...
                        className="w-28 h-20 bg-slate-800 rounded-lg border-2 border-slate-600 overflow-hidden relative shadow-xl"
                    >
                        <div className="absolute inset-0 bg-gradient-to-br from-slate-700 to-slate-900" />
                        {/* Placeholder for video - could use actual image */}
                        <div className="absolute inset-2 bg-slate-600/50 rounded" />
                        <div className="absolute bottom-1 left-1 bg-slate-900/90 px-1.5 py-0.5 rounded text-[8px] text-white flex items-center gap-1">
                ...
                {/* Bottom Control Bar */}
                <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex items-center gap-2 bg-slate-800/95 backdrop-blur-sm rounded-full px-4 py-2 border border-slate-600 shadow-xl">
                    {/* User avatar */}
                    <div className="flex items-center gap-2 pr-3 border-r border-slate-600">
                        ...
                        <div className="text-[10px]">
                            <div className="text-white font-medium">Andrew</div>
                    ...
                    <div className="flex items-center gap-1.5">
                        <button className="w-8 h-8 rounded-full bg-slate-700 hover:bg-slate-600 flex items-center justify-center text-slate-300 transition-colors">
                            <svg
                                className="w-4 h-4"
                                fill="currentColor"
                                viewBox="0 0 24 24"
                        ...
                        <button className="w-8 h-8 rounded-full bg-slate-700 hover:bg-slate-600 flex items-center justify-center text-yellow-400 transition-colors">
                            <svg
                                className="w-4 h-4"
                                fill="currentColor"
                                viewBox="0 0 24 24"
                    ...
                    <div className="flex items-center gap-1.5 pl-3 border-l border-slate-600">
                        ...
                        <span className="text-[10px] text-white">2 Online</span>
                        <span className="w-1.5 h-1.5 bg-green-400 rounded-full" />
                    </div>
                </div>
            </div>
