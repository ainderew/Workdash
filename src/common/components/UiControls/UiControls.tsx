...
function UiControls() {
    ...
    const isMatchHistoryModalOpen = useUiStore((state) => state.isMatchHistoryModalOpen);
    const closeMatchHistoryModal = useUiStore((state) => state.closeMatchHistoryModal);
