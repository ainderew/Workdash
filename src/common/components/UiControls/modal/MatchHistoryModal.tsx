...
import { X, Loader2, Trophy, Calendar, Target, Footprints, Zap, ChevronUp, ChevronDown } from "lucide-react";
            ...
            <div className="w-full max-w-2xl bg-neutral-900 border border-neutral-700 rounded-xl shadow-2xl p-6 animate-in fade-in zoom-in-95 duration-200 flex flex-col max-h-[80vh]">
                ...
                {isLoading ? (
                    <div className="flex-1 flex flex-col items-center justify-center py-12">
                        ...
                        <p className="text-neutral-400 text-sm">Loading matches...</p>
                    </div>
                ) : error ? (
                    <div className="flex-1 flex flex-col items-center justify-center py-12">
                    ...
                    <div className="flex-1 flex flex-col items-center justify-center py-12 text-center">
                        ...
                        <p className="text-neutral-600 text-sm mt-1">Play some games to see your history!</p>
                    </div>
                ) : (
                                ...
                                >
                                    <div className="flex items-center justify-between mb-3">
                                        ...
                                        <div className="flex items-center gap-2">
                                            <div className="text-lg font-black text-white">
                                                <span className={match.result === "WIN" ? "text-green-400" : "text-neutral-400"}>{match.ourScore}</span>
                                                <span className="mx-1 text-neutral-600">-</span>
                                                <span className={match.result === "LOSS" ? "text-red-400" : "text-neutral-400"}>{match.opponentScore}</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-4 gap-4">
                                        <div className="flex flex-col items-center p-2 rounded bg-neutral-900/40">
                                            <span className="text-[10px] text-neutral-500 uppercase font-bold mb-1">Goals</span>
                                        ...
                                        <div className="flex flex-col items-center p-2 rounded bg-neutral-900/40">
                                            <span className="text-[10px] text-neutral-500 uppercase font-bold mb-1">Assists</span>
                                            <div className="flex items-center gap-1 text-white font-bold">
                                        ...
                                        <div className="flex flex-col items-center p-2 rounded bg-neutral-900/40">
                                            <span className="text-[10px] text-neutral-500 uppercase font-bold mb-1">MMR</span>
                                            <div className={`flex items-center font-bold ${match.mmrDelta >= 0 ? "text-green-400" : "text-red-400"}`}>
                                                {match.mmrDelta >= 0 ? <ChevronUp size={14} /> : <ChevronDown size={14} />}
                                                {Math.abs(match.mmrDelta)}
                                            </div>
                                            <span className="text-[9px] text-neutral-600">{match.newMmr} total</span>
                                        </div>
                                        <div className="flex flex-col items-center p-2 rounded bg-neutral-900/40">
                                            <span className="text-[10px] text-neutral-500 uppercase font-bold mb-1">Rank</span>
                                            <span className="text-amber-500 font-bold text-xs">{match.rankAtTime}</span>
                                            {match.isMVP && (
                                                <div className="absolute -top-1 -right-1 bg-amber-500 rounded-full p-1 shadow-lg" title="MVP">
