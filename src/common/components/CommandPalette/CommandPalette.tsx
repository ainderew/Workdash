...
export default function CommandPalette() {
  ...
  return (
    <div
      ref={overlayRef}
      className="fixed inset-0 z-60 bg-black/60 backdrop-blur-sm flex items-start justify-center pt-32 animate-in fade-in zoom-in-95 duration-200"
    ...
    >
      <div className="w-full max-w-2xl mx-4">
        ...
        {currentCommandForm === 'poll' && <PollForm onClose={closeCommandPalette} />}
      </div>
    </div>
  );
}
